      ...
      <div class="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div class="lg:col-span-2">
          ...
          <div class="mb-6 flex items-center gap-3">
            <div class="flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-slate-700 to-slate-900 shadow-md">
              <svg class="h-7 w-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
            </div>
            <span class="text-2xl font-bold">Babatngon Explorer</span>
          </div>
          
          <p class="mb-6 max-w-md text-gray-400 leading-relaxed">
            Discover the pristine beaches, stunning resorts, and natural wonders of Babatngon, Leyte. Your gateway to paradise awaits.
          </p>
          ...
          <div class="flex gap-4">
            <a
              ...
              class="group flex h-10 w-10 items-center justify-center rounded-full bg-gray-800 transition-all duration-300 hover:-translate-y-1 hover:bg-gradient-to-br hover:from-orange-500 hover:to-pink-500 hover:shadow-lg"
            >
              <svg class="h-5 w-5 text-gray-400 transition-colors group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
                <path :d="social.icon" />
              </svg>
            </a>
          </div>
        ...
        <div>
          ...
          <ul class="space-y-3">
            <li>
              <a href="#" class="group flex items-center text-gray-400 transition-colors hover:text-white">
            ...
            <li>
              <a href="#resorts" class="group flex items-center text-gray-400 transition-colors hover:text-white">
                <svg class="mr-2 h-4 w-4 transition-transform group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                </svg>
                Destinations
        ...
        <div>
          ...
          <ul class="space-y-4">
            <li class="flex items-start gap-3 text-gray-400">
              <svg class="mt-1 h-5 w-5 flex-shrink-0 text-teal-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
              </svg>
              <span>Babatngon, Leyte, Philippines</span>
            </li>
            <li class="flex items-start gap-3 text-gray-400">
              <svg class="mt-1 h-5 w-5 flex-shrink-0 text-teal-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
              <span>info@babatngonexplorer.com</span>
            </li>
            <li class="flex items-start gap-3 text-gray-400">
              <svg class="mt-1 h-5 w-5 flex-shrink-0 text-teal-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="border-t border-gray-800 bg-gray-950 py-6">
      <div class="mx-auto max-w-7xl px-6">
        <div class="flex flex-col items-center justify-between gap-4 text-sm text-gray-400 md:flex-row">
          <p>© 2026 Babatngon Explorer. All rights reserved.</p>
